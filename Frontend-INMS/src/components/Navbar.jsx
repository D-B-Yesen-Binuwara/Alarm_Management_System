...
const Navbar = ({ onToggle }) => (
  <nav className="bg-gradient-to-r from-slate-900 via-sky-900 to-slate-800 text-white px-4 py-3 flex items-center justify-between shadow-md border-b border-emerald-400/40 flex-shrink-0">
